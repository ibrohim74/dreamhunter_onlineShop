...
namespace WBCR\Factory_Freemius_153;

use WBCR\Factory_Freemius_153\Sdk\Freemius_Api_WordPress;
use WBCR\Factory_Freemius_153\Sdk\Freemius_Exception;
...
final class Api {
	...
	/**
	 * @param Wbcr_Factory465_Plugin $slug
	 ...
	 */
	private function __construct( Wbcr_Factory465_Plugin $plugin, $scope, $id, $public_key, $secret_key, $is_sandbox ) {
	 ...
	 * @return Api
	 */
	public static function instance( Wbcr_Factory465_Plugin $plugin, $scope, $id, $public_key, $is_sandbox, $secret_key = false ) {
