...
namespace WBCR\Factory_Freemius_153\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory465_Plugin;
use WBCR\Factory_465\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_153\Premium\Provider
	 */
	private $premium;
	...
	{
		if( !$this->premium instanceof \WBCR\Factory_Freemius_153\Premium\Provider ) {
