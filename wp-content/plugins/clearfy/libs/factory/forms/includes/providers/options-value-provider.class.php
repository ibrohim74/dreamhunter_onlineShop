<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms462_OptionsValueProvider implements Wbcr_IFactoryForms462_ValueProvider {
