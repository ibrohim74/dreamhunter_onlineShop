<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms462_Bootstrap3FormLayout extends Wbcr_FactoryForms462_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms462_Control $control
			 */
