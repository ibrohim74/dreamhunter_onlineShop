<?php
	 ...
	 *  // see FactoryForms462_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms462_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms462_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms462_DropdownAndColorsControl extends Wbcr_FactoryForms462_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms462_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms462_RadioColorsControl($options['colors'], $form, $provider);
