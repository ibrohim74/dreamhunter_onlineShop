 ...
 * @since 1.0.0
 */
class WMAC_MinifyAndCombineSettingsPage extends WBCR\Factory_Templates_115\Pages\PageBase {
...
This can be fully automated for different types of pages with the Мinify And Combine CriticalCSS Power-Up.', 'minify-and-combine'),
		 ...
		 */
		return wbcr_factory_465_apply_filters_deprecated('wbcr_mac_settings_form_options', [$formOptions], '1.1.1', 'wmac/pages/settings_form_options');
	}
