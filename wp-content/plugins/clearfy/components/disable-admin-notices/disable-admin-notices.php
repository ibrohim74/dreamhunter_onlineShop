...
$wdan_plugin_info = array(
	...
	'load_factory_modules' => array(
		...
		array('libs/factory/clearfy', 'factory_templates_115', 'all'),
		array('libs/factory/freemius', 'factory_freemius_153', 'all'),
		array('libs/factory/adverts', 'factory_adverts_142', 'admin'),
		//array('libs/factory/logger', 'factory_logger_129', 'all')
	)
);

$wdan_compatibility = new Wbcr_Factory465_Requirements(__FILE__, array_merge($wdan_plugin_info, array(
