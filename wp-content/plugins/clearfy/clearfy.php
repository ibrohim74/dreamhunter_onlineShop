 ...
 * Framework Version: FACTORY_465_VERSION
 */
...
$plugin_info = [
	...
	'load_factory_modules' => [
		...
		['libs/factory/templates', 'factory_templates_115', 'all'],
		['libs/factory/freemius', 'factory_freemius_153', 'all'],
		['libs/factory/adverts', 'factory_adverts_142', 'admin'],
		['libs/factory/logger', 'factory_logger_129', 'all'],
...
$clearfy_compatibility = new Wbcr_Factory465_Requirements(__FILE__, array_merge($plugin_info, [
...
define('WCL_FRAMEWORK_VER', 'FACTORY_465_VERSION');
