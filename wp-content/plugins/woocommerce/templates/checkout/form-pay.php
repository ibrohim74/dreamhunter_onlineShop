...
<form id="order_review" method="post">
    ...
    <table class="shop_table">
        <thead>
            <tr>
                <th class="product-name"><?php esc_html_e( 'Maxsulot', 'woocommerce' ); ?></th>
                <th class="product-quantity"><?php esc_html_e( 'Soni', 'woocommerce' ); ?></th>
                <th class="product-total"><?php esc_html_e( 'Jami', 'woocommerce' ); ?></th>
            </tr>
        </thead>
        <tbody>
        ...
        <ul class="wc_payment_methods payment_methods methods">
            <?php
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li class="woocommerce-notice woocommerce-notice--info woocommerce-info">' . apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( "Kechirasiz, sizning joylashuvingiz uchun mavjud toʻlov usullari mavjud emas. Agar sizga yordam kerak bo'lsa yoki muqobil tartibga solishni xohlasangiz, biz bilan bog'laning.", 'woocommerce' ) ) . '</li>'; // @codingStandardsIgnoreLine
				}
				?>
        </ul>
        <?php endif; ?>
