<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_WpEditorControl') ) {

		class Wbcr_FactoryForms462_WpEditorControl extends Wbcr_FactoryForms462_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_462_URL . '/assets/css/editor.css';
				}
			}
