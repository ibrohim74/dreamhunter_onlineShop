<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms462_DatepickerRangeControl extends Wbcr_FactoryForms462_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms462_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms462_TextboxControl($options['range_2'], $form, $provider);
