<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms462_Control extends Wbcr_FactoryForms462_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms462_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms462_ValueProvider $provider
			 * @return void
			 */
