<?php
	...
	if( !class_exists('Wbcr_FactoryForms462_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms462_FormLayout extends Wbcr_FactoryForms462_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-462-' . $this->type);
				$this->addCssClass('factory-forms-462-' . $this->name);
			}
