...
function woocommerce_payme()
{
    ...
    class WC_PAYME extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->id = 'payme';
            $this->title = 'Payme';
            $this->description = __("Payme To'lov tizimi", '');
        ...
        public function generate_form($order_id)
        {
            ...
            $label_pay = __("To'lov", 'payme');
            $label_cancel = __('Buyurtmani bekor qilish', 'payme');
...
FORM;
        ...
        {
            echo '<p style="color:white">' . __("Buyurtma qabul qilindi to'lash uchun 'To'lov' tugmasini bosing", 'payme') . '</p>';
